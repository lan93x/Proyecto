...
<div class="ui container" id="categoria" >
      ...
      <table class="ui celled table">
          ...
          <tbody v-for="categoria in categorias">
            <tr>
              ...
              <td class="collapsing" v-else></td>
              <td class="collapsing">
                <?php echo $__env->make('categorias.delete', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  ...
  <?php echo $__env->make('categorias.create', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
